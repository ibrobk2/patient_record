...
<head>
    ...
    <title>Pharmacy Dashboard - PRMS</title>
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link" href="supervisors/">
                    ...
                    <span>Manage Supervisors</span></a>
            </li> -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Dashboard Menu View Prescriptions-->
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Supervisors</div>
                                                </div>
                                                <div class="col">
